...
.pictureCruising1{
  background-image: url("../Services/2.Services/RepairSails.png");
}
.pictureCruising2{
  background-image: url("../Services/2.Services/CanvasCleaning.png");
}
.pictureCruising3{
  background-image: url("../Services/2.Services/CanvasRepairs.png");
}
.pictureCruising4{
  background-image: url("../Services/2.Services/HadwareUpgrades.png");
}
.pictureCruising5{
  background-image: url("../Services/2.Services/FurlingSystemInstallation.png");
}
.pictureCruising6{
  background-image: url("../Services/2.Services/HandlingSystem.png");
}
.comeBack {
  all: unset !important;
